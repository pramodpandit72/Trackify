...
function Home() {
  ...
  return (
    <div className="pt-25">
      ...
      {/* Stats Section */}
      <section className="py-16 px-4 bg-linear-to-br from-white to-gray-50 border-t border-gray-200">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              <div className="text-5xl font-bold text-[#775fab] mb-2">92%</div>
              <p className="text-gray-700 font-medium">of clients report more consistency with exercise</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-[#775fab] mb-2">89%</div>
              <p className="text-gray-700 font-medium">of clients report increased strength</p>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-[#775fab] mb-2">73%</div>
              <p className="text-gray-700 font-medium">of clients report boosted confidence</p>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-linear-to-br from-orange-50 to-white border border-orange-100 rounded-2xl p-8">
              ...
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-3">Form Checks to Stay Safe</h3>
              <p className="text-gray-600 leading-relaxed">
                Your trainer is always a message away to review your form and keep you safe from injury.
              </p>
            </div>

            <div className="bg-linear-to-br from-pink-50 to-white border border-pink-100 rounded-2xl p-8">
              <div className="text-5xl mb-4">🌍</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-3">Anytime, Anywhere</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-linear-to-br from-yellow-50 to-white border border-yellow-100 rounded-2xl p-8">
              <div className="text-5xl mb-4">📊</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-3">Track Your Progress</h3>
              <p className="text-gray-600 leading-relaxed">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-linear-to-br from-purple-50 to-white border border-purple-100 rounded-2xl p-8">
              <div className="text-4xl mb-4">🏃</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-3">Current Fitness Level</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-linear-to-br from-blue-50 to-white border border-blue-100 rounded-2xl p-8">
              <div className="text-4xl mb-4">💪</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-3">Workout Preferences</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="bg-linear-to-br from-green-50 to-white border border-green-100 rounded-2xl p-8">
              <div className="text-4xl mb-4">🌟</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-3">Access to Equipment</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-24 px-4 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div className="text-center">
              <div className="text-6xl mb-6">🎓</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-4">Highly Experienced & Educated</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-4">Caring & Approachable</h3>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="text-center">
              <div className="text-6xl mb-6">⭐</div>
              <h3 className="text-2xl font-bold text-[#1a1a1a] mb-4">The Best Training Career</h3>
              <p className="text-gray-600 leading-relaxed">
      ...
      <section className="py-24 px-4 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">Whatever your fitness goal, we have trainers ready to help</p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {[
              ...
              <div key={idx} className="bg-linear-to-br from-purple-50 to-white border border-purple-100 rounded-xl p-6 text-center hover:shadow-lg transition-all">
                <p className="font-semibold text-[#1a1a1a]">{specialty}</p>
              </div>
            ))}
          </div>

          <div className="mt-12 p-8 bg-linear-to-r from-[#775fab]/10 to-[#32284a]/10 rounded-2xl border border-purple-100 text-center">
            <p className="text-lg text-gray-700 font-medium">And so much more! 🎯</p>
          </div>
        </div>
      </section>
